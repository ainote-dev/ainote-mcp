...
import { getDevDocTools } from '../tools/dev-doc-tools.js';
import { getOnboardingTools } from '../tools/onboarding-tools.js';
...
function registerTools(registry, { includeChatGpt }) {
  // Onboarding tools are always registered (work without API key)
  registry.registerMany(getOnboardingTools());
  registry.registerMany(getSharedTools());
  registry.registerMany(getDevDocTools());
